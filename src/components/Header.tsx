...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed inset-0 bg-[rgba(11,13,26,0.97)] backdrop-blur-2xl z-40 transition-all duration-500 flex flex-col items-center justify-center gap-8 ${
